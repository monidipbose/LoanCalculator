...
class TimerApp:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Loan Calculator - Minute")
        ...
        self.rate_label = tk.Label(self.textboxes_frame, text="Rate per minute (₹):", font=("Helvetica", 14),
                                   bg=self.bg_color, fg=self.label_color)
        ...
        self.rate_display_label = tk.Label(self.root, text="Rate per minute (₹): ", font=("Helvetica", 14),
                                           bg=self.bg_color, fg=self.label_color)
    ...
    def reset_timer(self):
        ...
        self.rate_display_label.config(text="Rate per minute (₹):")
    ...
    def update_clock(self):
        if self.running:
            ...
            final_amount = (math.ceil(elapsed_time / 60) * self.rate)  + self.base_price
    ...
    def validate_inputs(self):
        ...
        if not rate.replace(".", "").isdigit():
            ...
            self.rate_display_label.config(text=f"Rate per minute (₹): {rate}")
